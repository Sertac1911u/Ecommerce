...
namespace Ecommerce.WebUI.Services.Concretes
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<bool> GetRefreshToken()
        {
            ...
            {
                ClientId = _clientSettings.EcommerceAdminClient.ClientId,
                ClientSecret = _clientSettings.EcommerceAdminClient.ClientSecret,
            ...
            var authenicationToken = new List<AuthenticationToken>()
            {
            ...
            properties.StoreTokens(authenicationToken);
